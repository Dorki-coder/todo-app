...
var _sampletodos = require("./sampletodos");
...
if (theme == JSON.parse(localStorage.getItem(THEME_STORAGE_KEY))) body.classList.add(`${theme}-mode`);
else body.classList.remove(`${theme}-mode`);
...
active.forEach((element2)=>{
    element2.addEventListener("click", ()=>{
        const newList = [
            ...list.children
        ];
        newList.forEach((item)=>{
            if (item.firstElementChild.firstElementChild.checked == true) item.style.display = "none";
...
completed.forEach((element3)=>{
    element3.addEventListener("click", ()=>{
        const newList = [
            ...list.children
        ];
        newList.forEach((item)=>{
            if (item.firstElementChild.firstElementChild.checked == true) item.style.display = "flex";
...
let sortable = new _sortablejsDefault.default(list, {
    animation: 100,
    draggable: ".list-item",
    onSort: ()=>{
        let items = [
...
},{"../styles/main.scss":"bo7w8","./sampletodos":"7egCZ","sortablejs":"4mik1","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bo7w8":[function() {},{}],"7egCZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "sampleTodos", ()=>sampleTodos
);
const sampleTodos = [
    {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["l4AUa","ebWYT"], "ebWYT", "parcelRequire546b")
